                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="about-item text-center">
                                ...
                                <h3>CONSUMATORI</h3>
                                <p class="p-3">La consegna del cibo è un business iperlocale. Pensiamo alla nostra offerta ai consumatori quartiere per quartiere.
                                    ...
                                    La nostra proposta ai consumatori mira a fornire sempre la migliore disponibilità, selezione, esperienza e valore, costruendo allo stesso tempo una connessione emotiva con il nostro marchio.
                                </p>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="about-item text-center">
                                ...
                                <h3>RIDER</h3>
                                <p class="p-3">Costruiamo la nostra proposta per i ciclisti in base alle cose che ci dicono di apprezzare di più.
